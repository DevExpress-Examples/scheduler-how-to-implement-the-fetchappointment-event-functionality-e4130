...
End Function
    ...
    Dim insertedAppt() As DBAppointment = SchedulerExtension.GetAppointmentsToInsert(Of DBAppointment)(SchedulerSettingsHelper.CommonSchedulerSettings, SchedulerDataHelper.GetAppointments(), SchedulerDataHelper.GetResources())
